        ...
        <div class="templatemo-content">
	          <ol class="breadcrumb">
	            ...
	            <li><a href="../../sign-in.html">Sign In Form</a></li>
	             <li><a href="javascript:synchronousCtml()">同步证书模板 /</a><a href="javascript:searchByCondition()"> 查询</a></li>
	          </ol>
        <div class="row">
            <div class="col-md-12">
...
function activate(id){
 ...
 function synchronousCtml(){
  self.location.replace("synchronousCtml.do");
 }
