...
public class CertTemplate {
	 ...
	 * 密钥对类型，引用数据字典表
	 */
	private SysCode kpgAlgorithm;
	
	/**
	 * 有效期天数
	 */
	private SysCode validity;
	...
	public SysCode getKpgAlgorithm() {
		return kpgAlgorithm;
	}

	public void setKpgAlgorithm(SysCode kpgAlgorithm) {
		this.kpgAlgorithm = kpgAlgorithm;
	}

	public SysCode getValidity() {
		return validity;
	}

	public void setValidity(SysCode validity) {
