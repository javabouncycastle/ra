 ...
 *
 */
public class CaStartSocketThread extends Thread{
	
	private static final Log LOG = LogFactory.getLog(CaStartSocketThread.class);
	
	private CaSocketService socketService; 
	private ServerSocket serverSocket;
	
	public CaStartSocketThread(CaSocketService socketService,ServerSocket serverSocket) {
		...
		try {  
            ...
            if(null == serverSocket){  
                ...
                while (true) {
                    ...
                    new Thread(new CaSocketThread(socket,socketService)).start();
