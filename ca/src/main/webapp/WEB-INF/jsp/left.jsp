    	...
    	<div class="navbar-collapse collapse templatemo-sidebar" style="height:auto">
        	<ul class="templatemo-sidebar-menu">
         		...
         		<li class="sub">
		            ...
		            <ul class="templatemo-submenu">
		              <li  ><a href="<%=request.getContextPath()%>/auditOpLog/selectAll.do"><font style='font-family:"微软雅黑"'>日志列表</font></a></li>
		            </ul>               
          		</li>
            	<li class="sub">
		            <a href="javascript:;">
         		...
         		<li class="sub">
		            <a href="javascript:;">
		              <i class="fa fa-database"></i><font style='font-family:"微软雅黑"'>模板管理</font><div class="pull-right"><span class="caret"></span></div>
		            </a>
		            <ul class="templatemo-submenu">
		              <li  ><a href="<%=request.getContextPath()%>/certTemplate/selectAll.do"><font style='font-family:"微软雅黑"'>证书模板列表</font></a></li>
		            </ul>               
         		</li>
