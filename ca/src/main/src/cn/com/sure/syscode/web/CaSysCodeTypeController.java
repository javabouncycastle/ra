...
public class CaSysCodeTypeController {
	
	private static final Log LOG = LogFactory.getLog(CaSysCodeTypeController.class);
	...
	public String insert(CaSysCodeType sysCodeType,
	...
	public String update(CaSysCodeType sysCodeType,
			Model model, RedirectAttributes attr,HttpServletRequest request){
	...
	public ModelAndView selectAll(CaSysCodeType sysCodeType,
			Model model, RedirectAttributes attr,HttpServletRequest request){
		LOG.debug("selectAll - start");
		List<CaSysCodeType> sysCodeTypes=this.sysCodeTypeService.selectAll(sysCodeType);
	...
	public ModelAndView searchByCondition(CaSysCodeType sysCodeType,
			Model model, RedirectAttributes attr,HttpServletRequest request){
		LOG.debug("searchByCondition - start");
		List<CaSysCodeType> sysCodeTypes=this.sysCodeTypeService.searchByCondition(sysCodeType);
    ...
    //比较更新了那些字段
    public String compare(CaSysCodeType sysCodeTypeNew){
    	String resultString="";
		//查询数据库中未更新前的数据
		CaSysCodeType sysCodeTypeDB = sysCodeTypeService.selectById(sysCodeTypeNew.getId());
