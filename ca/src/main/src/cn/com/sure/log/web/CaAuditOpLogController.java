...
import cn.com.sure.syscode.web.CaSysCodeController;
...
public class CaAuditOpLogController extends BaseController {
	...
	public ModelAndView selectAll(){
		...
		List<CaAuditOpLog> auditOpLogs = auditOpLogService.selectAll();
	...
	public ModelAndView searchByCondition(CaAuditOpLog auditOpLog,
			Model model, RedirectAttributes attr,HttpServletRequest request){
		LOG.debug("searchByCondition - start");
		List<CaAuditOpLog> auditOpLogs = auditOpLogService.searchByCondition(auditOpLog);
	...
	public String exportExcel(HttpServletResponse response,CaAuditOpLog auditOpLog) throws Exception{
